package com.example.prawoto.tokofitriaretnowati;
...
public class MainActivity extends AppCompatActivity {
     ...
     private Button btnexit;
      ...
      protected void onCreate(Bundle savedInstanceState) {
               ...
               getSupportActionBar().setTitle("Toko Arman");

                edtnamapel = (EditText) findViewById(R.id.namapelanggan);
                  edtid = (EditText) findViewById(R.id.idbarang);
                ...
                btnhapus = (Button) findViewById(R.id.tombol2);
                 ...
                 txtnamapel = (TextView) findViewById(R.id.namapelanggan);
                  txtid = (TextView) findViewById(R.id.idbarang);
              ...
              @Override
               public void onClick(View view) {
                                  ...
                                  String idbarang = edtid.getText().toString().trim();
